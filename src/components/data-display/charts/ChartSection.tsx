...
import { CustomerRankingChart, CustomerRankingChartData } from "./CustomerRankingChart";
...
const ChartSection = ({ revenueData, bestSellersData, customerRankingData }: ChartSectionProps) => {
    ...
    return (
        <Card>
            ...
            <CardContent>
                ...
                {graph === "clientes-ranking" && <CustomerRankingChart data={customerRankingData} />}
            </CardContent>
        </Card>
    );
};
